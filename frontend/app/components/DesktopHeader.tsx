    ...
    return (
        ...
        <div className={`z-10 flex justify-between h-18 items-center pl-8 pr-4 fixed top-0 right-0 left-0 transition-all duration-300 ease-in-out ${scrolled? "bg-white/10 backdrop-blur-lg shadow-lg":""}`}>
            ...
            <div className="flex gap-3 items-center">
                <Link href="/Login" className="transition-all duration-200 ease-in-out bg-transparent text-[#a5a5ff] border border-[rgba(108,108,245,0.6)] px-6 py-2.5 rounded-lg text-sm font-medium hover:bg-[rgba(108,108,245,0.6)] hover:text-white">Sign In</Link>
