...
export default function MobileHeader(){
    ...
    return(
        <>
        <div className={`flex justify-between h-18 items-center px-4 fixed top-0 right-0 left-0 ${scrolled? "bg-white/10 backdrop-blur-lg":""}`}>
            <div className="flex gap-2 items-center hover:cursor-pointer">
                ...
                <h1 className="text-lg font-bold">Clock In</h1>
            </div>
