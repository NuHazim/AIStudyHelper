...
export default function MobileHeader(){
    ...
    return(
        <>
        <div className={`z-10 flex transition-all duration-300 ease-in-out justify-between h-18 items-center px-4 fixed top-0 right-0 left-0 border-[#1a1a5e] ${scrolled? "bg-[#050510] border-b border-[#1a1a5e]":""}`}>
